...
const teamMembers = [
  ...
  },
  {
    ...
    description:
      "Fokus pada antarmuka pengguna, tata letak, dan responsivitas.",
  },
  {
    name: "Nama Anggota 3",
    role: "Pengembang Backend",
    description:
      "Mengurus logika server, API, dan pengelolaan data kalkulator.",
  },
  {
    name: "Nama Anggota 4",
  ...
  },
  {
    ...
    role: "Penguji & QA",
    description:
      "Memastikan kualitas, mengidentifikasi bug, dan menguji fungsionalitas.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border-t-4 border-indigo-500 hover:shadow-xl transition duration-300">
              ...
              <p className="text-gray-600">
                Alat bantu untuk memecahkan Derivatif, Integral, dan limit
                secara akurat.
              </p>
            </div>
            {/* Kartu Fitur 2 */}
            <div className="bg-white p-6 rounded-xl shadow-lg border-t-4 border-indigo-500 hover:shadow-xl transition duration-300">
              ...
              <p className="text-gray-600">
                Materi yang disusun langkah demi langkah, mudah dipahami oleh
                pelajar.
              </p>
            </div>
            {/* Kartu Fitur 3 */}
            <div className="bg-white p-6 rounded-xl shadow-lg border-t-4 border-indigo-500 hover:shadow-xl transition duration-300">
              ...
              <p className="text-gray-600">
                Platform web yang responsif, optimal di desktop dan perangkat
                mobile.
              </p>
            </div>
          </div>
      ...
      <footer className="py-6 text-center bg-gray-100 text-gray-500 text-sm">
        &copy; {new Date().getFullYear()} SkyLearn. All rights reserved.
        Kelompok 1.
      </footer>
    </div>
  );
